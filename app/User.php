...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'bio', 'image_path',
    ];
    ...
    /**
     * 指定された $postIdの投稿をこのユーザがお気に入り追加であるか調べる。フォロー中ならtrueを返す。
     *
     * @param  int  $postId
     * @return bool
     */
    ...
    {
        // お気に入り中の投稿の中に $postIdのものが存在するか
        return $this->favorites()->where('post_id', $postId)->exists();
    }
    
    /**
     * このユーザが所有するGoal。（ Goalモデルとの関係を定義）
     */
